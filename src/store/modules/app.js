...
const app = {
    ...
    mutations: {
        ...
        updateMenulist(state) {
            let menuList = [];
            // let menuAuthList = Cookies.get('authMenu');
            // if (menuAuthList !== undefined && menuAuthList.length > 0) {
                appRouter.forEach((item, index) => {
                    if (item.children.length === 1) {
                        ...
                        childrenArr = item
                            .children
                            .filter(child => {
                                // if (menuAuthList.indexOf(item.path + "/" + child.path) != -1) {
                                    // child.auth = true;
                                    return child;
                                // }
                            });
