...
export default {
    ...
    methods: {
            ...
            this.$refs["userForm"].validate(valid => {
                if (valid) {
                    ...
                    let timer = setInterval(() => {
                        if (timeLast >= 0) {
                            this.gettingIdentifyCodeBtnContent =
                                timeLast + "秒后重试";
                            timeLast -= 1;
                        } else {
                            clearInterval(timer);
        ...
        resetPwd() {
            ...
            util.ajax.put("/users/" + uid, {
                resetPwdOld:this.editPasswordForm.oldPass,
                resetPwdRept1:this.editPasswordForm.newPass,
                resetPwdRept2:this.editPasswordForm.rePass
            }).then(rsp => {
            ...
            util.ajax
                ...
                .then(res => {
                    if (res.data.code == 200) {
                        ...
                        console.log(data);
                        this.userForm.name = data.realName;
                        this.userForm.cellphone = data.phoneNum;
                        this.initPhone = data.phoneNum;
                        this.userForm.company = "SIXO";
                        this.userForm.department = "可视化部门";
                    } else {
